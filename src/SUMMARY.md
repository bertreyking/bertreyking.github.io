...
- [Prometheus](other/prometheus/prometheus.md)
  ...
  - [使用](other/prometheus/prometheus_usege.md)
    ...
    - [Grafana 自定义子路径](other/prometheus/grafana_subpath.md)
    - [Grafana_重名字段匹配](other/prometheus/grafana-pod-same.md)
    - [Grafana_自定义面板存放目录](other/prometheus/grafana-dashboard-folder-guide.md)
...
- [Jenkins 学习]()
  ...
  - [邮件通知](other/jenkins/jenkins-mailer.md)
